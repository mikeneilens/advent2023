    ...
    "part one" should ({
        ...
        "numberChunks adjacent to symbols in the test data" {
            val expectedResult = listOf(
                ...
                NumberChunk(columnRange=6..8, row=2, testData),
                NumberChunk(columnRange=0..2, row=4, testData),
                NumberChunk(columnRange=2..4, row=6, testData),
                NumberChunk(columnRange=6..8, row=7, testData),
                NumberChunk(columnRange=1..3, row=9, testData),
                NumberChunk(columnRange=5..7, row=9, testData))
            testData.toNumberChunks().chunksAdjacentToSymbols() shouldBe expectedResult
        }
